...
///////////////////////////////////////////////////////////////////////////////
// Forward Butterfly Operation with OktinyMP
///////////////////////////////////////////////////////////////////////////////
        ...
        complex_vector x, complex_vector y) noexcept
{
    complex_vector z = eo ? y : x;
    if (s >= 2) {
        const int i0 = okt::i0(s/2);
        const int iN = okt::iN(s/2);
        //for (int q = 0; q < s; q += 2)
        for (int i = i0; i < iN; i++) {
            const int q = 2*i;
            complex_vector xq = x + q;
        ...
        complex_vector x, complex_vector y, const_complex_vector W) noexcept
{
    ...
    const int N1 = N/2;
    if (s >= 2) {
        const int i0 = okt::i0(N/4);
        const int iN = okt::iN(N/4);
        //for (int i = 0; i < N/4; i++)
        for (int i = i0; i < iN; i++) {
            const int p = i / (s/2);
            const int q = i % (s/2) * 2;
        ...
        const int i0 = okt::i0(m);
        const int iN = okt::iN(m);
        //for (int p = 0; p < m; p++)
        for (int p = i0; p < iN; p++) {
            complex_vector x_p  = x + p;
            complex_vector y_2p = y + 2*p;
        ...
        complex_vector x, complex_vector y, const_complex_vector W) noexcept
{
    ...
    const int N3 = N1*3;
    if (s >= 2) {
        const int i0 = okt::i0(N/8);
        const int iN = okt::iN(N/8);
        //for (int i = 0; i < N/8; i++)
        for (int i = i0; i < iN; i++) {
            const int p = i / (s/2);
            const int q = i % (s/2) * 2;
        ...
        complex_vector x, complex_vector y, const_complex_vector W) noexcept
{
    ...
    const int N7 = N1*7;
    if (s >= 2) {
        const int i0 = okt::i0(N/16);
        const int iN = okt::iN(N/16);
        ...
        complex_vector x, complex_vector y, const_complex_vector W) noexcept
{
    ...
    const cpx w4 = mulpz(w2,w2);
    complex_vector z = eo ? y : x;
    const int i0 = okt::i0(s);
    const int iN = okt::iN(s);
    //for (int q = 0; q < s; q++)
    for (int q = i0; q < iN; q++) {
        const cpx a = getpz(x[q+s*0]);
        const cpx b = getpz(x[q+s*1]);
        ...
        complex_vector x, complex_vector y, const_complex_vector W) noexcept
{
    ...
    const cpx w3 = mulpz(w1,w2);
    const cpx w4 = mulpz(w2,w2);
    const int i0 = okt::i0(ms);
    const int iN = okt::iN(ms);
    //for (int i = 0; i < ms; i++)
    for (int i = i0; i < iN; i++) {
        const int p = i / s;
        const int q = i % s;
...
///////////////////////////////////////////////////////////////////////////////
// Any Size FFT except Radix-2,3,5 with OktinyMP
///////////////////////////////////////////////////////////////////////////////
        ...
        complex_vector x, complex_vector y, const_complex_vector W) noexcept
{
    ...
    if (k == n) {
        ...
        if (!eo) {
            oktinymp.wait();
            const int p0 = okt::i0(N);
            const int pN = okt::iN(N);
            //for (int p = 0; p < N; p++)
            for (int p = p0; p < pN; p++)
                setpz(x[p], getpz(y[p]));
        }
...
///////////////////////////////////////////////////////////////////////////////
// Inverse Butterfly Operation with OktinyMP
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
// Any Size IFFT except Radix-2,3,5 with OktinyMP
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
// Mixed Radix IFFT with OktinyMP
///////////////////////////////////////////////////////////////////////////////
